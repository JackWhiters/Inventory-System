    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createCategory', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addModal" style="background: linear-gradient(to right, #673ab7, #512da8); border: none;">Tambah Kategori</button>
          <br /> <br />
        <?php endif; ?>
